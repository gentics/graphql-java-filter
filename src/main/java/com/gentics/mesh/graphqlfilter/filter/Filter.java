 ...
 *
 * The idea is to create a predicate based on the filter a user is providing in a query,
 * which then can be used to filter the collection of items the user is requesting.
 *
...
public interface Filter<T, Q> {
    ...
    /**
     * The type of this filter to be used in GraphQl.
     * This describes the options the user can choose to refine the filter.
     */
