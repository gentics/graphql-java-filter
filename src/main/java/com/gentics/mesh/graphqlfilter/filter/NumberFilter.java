...
public class NumberFilter extends MainFilter<BigDecimal> {
    ...
    protected List<FilterField<BigDecimal, ?>> getFilters() {
        return Arrays.asList(
            FilterField.isNull(),
            FilterField.<BigDecimal, BigDecimal>create("equals", "Compares two numbers for equality. Be careful when comparing floating point numbers, they might be not exact. In that case, use closeTo instead.",
